    ...
    {#if !loading}
        ...
        <div class="playlists">
            ...
            {#each playlists as item,i}
                ...
                <button class="albumbutton contextMenuPlaylist" onclick="{ () => CallItem({query:i, type: 'playlist'})}">
        ...
        <p>album che ti piacciono</p>

        <div class="likedAlbums">

            {#each albums as album}
                
                <button onclick="{ () => CallItem({query: album.artist + ' - ' + album.album, type: 'album'})}" class="albumbutton contextMenuAlbum" >
        ...
        <p>artisti che segui</p>

        <div class="likedArtists">

            {#each artists as artist}
        
                <button class="albumbutton contextMenuArtist" onclick="{ () => CallItem({query: artist.artist, type: 'artist'})}">
                    <img class="--IMGDATA artimg" src="{artist.img}" alt="">
                    <p class="--ARTISTDATA">{artist.artist}</p>
                </button>
        ...
        {#if creatingPlist}
            <div id="PlaylistCreator">
                ...
                <div id="newPpannel">
                    ...
                    <img id="NewPlaylistimg" style="width: 200px; height: 200px; object-fit: cover;" src="{imageSrc}" alt="">
